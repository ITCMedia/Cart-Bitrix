...
<div id="panel"><?$APPLICATION->ShowPanel();?></div>
	...
	"ROOT_MENU_TYPE" => "left",	// Ө殾 嬿 র㯣𮢭󍊉	"MENU_CACHE_TYPE" => "A",	// Ө湨𮢠
		"MENU_CACHE_TIME" => "36000000",	// ð歿 릸鱮㡭鿠(񥪮)
		"MENU_CACHE_USE_GROUPS" => "N",	// Է鳻㡲𠯰ᣠ 寱򳯠
		"MENU_CACHE_GET_VARS" => "",	// ȭḨ󙐠র步塧ᰰﲠ
		"MAX_LEVEL" => "3",	// ԰㬮禭򨠬殾
		"CHILD_MENU_TYPE" => "lefto",	// Ө殾 嬿 ﲲᬼ 󰮢
		"USE_EXT" => "Y",	// Ю嫫򷠲𠴠ꬻ 񠨬殠򘉤࠮򨯟񻙺󩑮u_ext.php
		"DELAY" => "N",	// ϲ묠弢᳼ 㼯שּׂ殨塸᢫ﮠ 񻗴򲐉"ALLOW_MULTI_SELECT" => "N",	// Ѡ豥𨲼 믫𪮠᫲飭󵠯󭪲省步
	),
	false
);
					?>
		...
		<div class="wrap">
			<div class="mlfShap">
				...
				<div class="rightShapWrap">
					<div class="blockPhEm">
						<div class="phone">+7 921 111-11-11</div>
						<div class="email">info@asz-magazine.ru</div>
					</div>
	...
	"ROOT_MENU_TYPE" => "bottomshap",	// Ө殾 嬿 র㯣𮢭󍊉	"MENU_CACHE_TYPE" => "A",	// Ө湨𮢠
		"MENU_CACHE_TIME" => "36000000",	// ð歿 릸鱮㡭鿠(񥪮)
		"MENU_CACHE_USE_GROUPS" => "N",	// Է鳻㡲𠯰ᣠ 寱򳯠
		"MENU_CACHE_GET_VARS" => "",	// ȭḨ󙐠র步塧ᰰﲠ
		"MAX_LEVEL" => "4",	// ԰㬮禭򨠬殾
